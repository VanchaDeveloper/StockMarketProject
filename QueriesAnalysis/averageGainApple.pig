...
Gain_Loss_per_day = FOREACH apple GENERATE dates , (((close-open)/open)*100) as change , ((((close-open)/open)*100)>0?'G':'L') as gain_loss , ((close-open)>0?(close-open):0) as gain ,((close-open)<0?(open-close):0) as loss;
